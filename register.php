...
<?php
$cities = ["Arakkonam","Ariyalur","Chennai","Coimbatore","Cuddalore","Dharmapuri","Dindigul","Erode","Hosur","Kallakurichi","Kanchipuram","Karaikudi","Karur","Kumbakonam","Kumbam","Madurai","Melur","Nagapattinam","Nagercoil","Namakkal","Neyveli","Ooty","Perambalur","Pollachi","Pudukkottai", "Ramanathapuram","Salem","Sivaganga","Sivakasi","Thanjavur","Theni","Thoothukudi","Tirunelveli","Tiruppur","Trichy","Vellore","Viluppuram ","Virudhunagar ","Udumelpet"];
?>
